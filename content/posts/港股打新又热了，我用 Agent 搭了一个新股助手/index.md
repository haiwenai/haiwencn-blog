...
后来他刷了花呗，把钱转进去，兴冲冲打了一只热门新股的乙组。结果这只新股配得不少，暗盘却直接破发。分配多，亏得也多。最后所谓的打新赚钱，变成了搬砖还债。
...
你要看招股价、入场费、每手股数、认购日期、上市日。还要看一手中签率、甲尾中签率、乙头中签率、公开认购人数、超购倍数、回拨比例、绿鞋、国配、基石投资者。

当然，老师傅有自己的经验，以上没那么重要。
...
它不是自动荐股，也不是让 AI 告诉我哪只可以买。它要做的事更具体：把港股新股从招股、配发、暗盘、首日到后续表现，整理成一个可以持续看的数据系统。
...
负责发现新股、搜索 HKEX、下载招股书和配发结果 PDF。

负责解析招股书。

负责解析配发结果。

还有一个专门用来审计 PDF 解析结果和数据库是不是对得上。
...
后端定时任务也按节奏跑：发现新股、补招股书、查配发结果、同步暗盘、首日数据、累计涨幅等等。
